...
FEATURE_DIR = Path('/workspace/tests/features/environment_inventory_generation')
    ...
    for feature_file in FEATURE_DIR.glob('*.feature'):
        ...
        for scenario in scenarios[1:]:
            ...
            if match:
                ...
                uc_code = f"einv_{safe_title}"
                ref_name = f"einv-{safe_title.replace('_', '-')}"
...
if __name__ == '__main__':
    process_features()
    print("Done generating stubs for environment_inventory_generation.")
