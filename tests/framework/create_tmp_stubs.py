...
FEATURE_DIR = Path('/workspace/tests/features/template_override')
    ...
    for feature_file in FEATURE_DIR.glob('*.feature'):
        ...
        for scenario in scenarios[1:]:
            ...
            if match:
                ...
                uc_code = f"tmp_{safe_title}"
                ref_name = f"tmp-{safe_title.replace('_', '-')}"
...
if __name__ == '__main__':
    process_features()
    print("Done generating stubs for template_override.")
