...
source_dir = r"f:\project\qubership-envgene\tests\features\todo\effective_set_generation"
target_dir = r"f:\project\qubership-envgene\tests\features\effective_set_generation"
