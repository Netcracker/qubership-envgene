...
from python.envgene.envgenehelper import openYaml, unpack_archive, cleanup_dir, yaml, addHeaderToYaml, crypt
...
def process_decryption(base_dir):
    parser = argparse.ArgumentParser()
    parser.add_argument('-e', '--env_name', help="", type=str)
    args = parser.parse_args()
    logger.info(f"Decrypting credentials for env: {args.env_name}")
    ...
    logger.info(f"Using cred file: {cred_path}")
