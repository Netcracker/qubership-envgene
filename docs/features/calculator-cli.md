...
| `CLOUD_PRIVATE_HOST`              | no       | string  | Cluster's API endpoint accessible outside the cluster network                                                                                                                                                                                                                                                                                                                                                                                                                                                     | None                                                                           | `privateUrl` in the `Cloud`                                                                  |
| `CLOUD_PROTOCOL`                  | no       | string  | Cluster's API protocol (http or https)                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | None                                                                           | `protocol` in the `Cloud`                                                                    |
| `CLOUD_API_PORT`                  | no       | string  | Cluster's API port                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | None                                                                           | `apiPort` in the `Cloud`                                                                     |
