...
| `--enable-traceability`/`-etr`                      | boolean | no        | Determines whether [traceability](#version-20-traceability-in-the-effective-set) will be enabled. If `true`, traceability comments will be added. If `false`, they will be omitted.                                           | `false` | `true`                                                                               |
...
2. [Application SBOM](/docs/sbom.md#application-sbom)
...
2. Service level defined in Application SBOM (including Resource Profile Baseline)
3. Calculator-generated at the Service level
4. User-defined at the [Application](/docs/envgene-objects.md#application) level in Environment Instance
5. Application level defined in Application SBOM
6. Calculator-generated at the Application level
7. User-defined at the [Namespace](/docs/envgene-objects.md#namespace) level in Environment Instance
8. Namespace level defined in Application SBOM
9. Calculator-generated at the Namespace level
10. User-defined at the [Cloud](/docs/envgene-objects.md#cloud) level in Environment Instance
11. Cloud level defined in Application SBOM
12. Calculator-generated at the Cloud level
13. User-defined at the [Tenant](/docs/envgene-objects.md#tenant) level in Environment Instance
14. Calculator pipeline parameters (`--extra_params`)
15. Default values by calculator
