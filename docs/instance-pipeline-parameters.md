...
|-------------------------------------------|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------------------------------------|
| **version**                               | Optional  | Effective Set contract version to generate. EnvGene passes this to the Calculator CLI as `--effective-set-version`. Supported: `v1`, `v2` (latest minor within that major); `v1.0`, `v2.0` (deprecated, kept for backward compatibility); specific minor e.g. `v2.1`, `v2.2` when supported.                                                                                                                                                                                                                  | `v2`                                   | `v2`, `v2.1`                                       |
