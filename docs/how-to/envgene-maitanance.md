...
1. Go to the [EnvGene release page](https://git.netcracker.com/PROD.INMRND.MANO/DevOps/ReleaseEngineering/SandboxTestEnvironment/configuration-management/env-generator/-/releases).
