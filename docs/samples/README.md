...
For migrating a non-BG template and environment to Blue-Green Deployment (BGD), see
[BGD samples](/docs/samples/bgd/) and the
[configuration how-to](/docs/how-to/blue-green-deployment-configuration.md).
