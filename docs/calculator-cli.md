...
Only services that are generated based on a component with type `application/vnd.qubership.service`, service-specific parameters include **performance parameters** generated by merging:
