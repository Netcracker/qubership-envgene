...
##### \[Version 2.0][Deployment Parameter Context] Per Service `deployment-parameters.yaml`
...
Only services that are generated based on a component with type `application/vnd.qubership.service`, `application/vnd.qubership.configuration.smartplug`, `application/vnd.qubership.configuration.frontend`, `application/vnd.qubership.configuration.cdn`, `application/vnd.qubership.configuration`service-specific parameters include **performance parameters** generated by merging:
