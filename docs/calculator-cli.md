...
5. Calculator CLI must resolve [macros](#version-20-macros)
...
SBOMs for Effective Set calculation are optional. When the Сalculator CLI is launched without the following attributes:
...
Calculator CLI resolves [macros](/docs/template-macros.md#calculator-cli-macros)
