...
- [Calculator CLI Use Cases](#calculator-cli-use-cases)
  ...
  - [Parameter Type Preservation in Macro Resolution](#parameter-type-preservation-in-macro-resolution)
    ...
    - [UC-CC-MR-4: Same Key Defined at Multiple Levels Resolves to Nearest Scope](#uc-cc-mr-4-same-key-defined-at-multiple-levels-resolves-to-nearest-scope)
  - [Custom Parameters Injection](#custom-parameters-injection)
    ...
    - [UC-CC-CP-3: CUSTOM_PARAMS with Mixed Top-Level and Namespace Keys Fails](#uc-cc-cp-3-custom_params-with-mixed-top-level-and-namespace-keys-fails)
