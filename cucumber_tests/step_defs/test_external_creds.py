...
from cucumber_tests.shared_steps.calculator_cli_steps import *
...
from cucumber_tests.step_defs.external_creds_steps import *    # noqa: F401,F403

scenarios('../features/external-creds.feature')
