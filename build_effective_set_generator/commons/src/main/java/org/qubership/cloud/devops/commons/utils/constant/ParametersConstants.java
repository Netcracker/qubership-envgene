...
public class ParametersConstants {
    public static final String TENANT_ORIGIN = "Env/Tenant: %s",
            ...
            PARAMETER_SET_APP_ORIGIN = "Params/Application: %s/%s",
            ...
            CLOUD_PARAMETER_SET_APP_ORIGIN = "Params/Cloud/Application: %s/%s/%s/%s",
            CLOUD_APP_ORIGIN = "Env/Cloud/Application: %s/%s/%s",
