...
public class SecretNameBuilder {
    ...
    public static String buildNormalizedSecretName(String remoteRefPath, String credId, SecretStoreType secretStoreType) {
        try {
            return org.qubership.cloud.extcreds.valsref.SecretNameBuilder.buildNormalizedSecretName(
                    remoteRefPath,
                    credId,
                    org.qubership.cloud.extcreds.valsref.SecretStoreType.valueOf(secretStoreType.name())
            );
