...
public final class ValsUriBuilder {

    private ValsUriBuilder() {
    }

    public static String buildValsUri(SecretStoreConfig store, String normalizedSecretName, String fragment) {
