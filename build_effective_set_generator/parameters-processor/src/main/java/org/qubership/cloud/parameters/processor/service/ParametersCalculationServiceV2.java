...
public class ParametersCalculationServiceV2 {
    ...
    private void handleDeployParameters(ParameterBundle parameterBundle, Map<String, Object> k8TokenMap, String originalNamespace, Map<String, Object> finalSecuredParams, Map<String, Object> inSecuredParamsAsObject) {
